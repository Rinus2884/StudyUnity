...
public class CSceneAudioMixer_step_3     : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(0, 200, 100, 100), "Master Volume Up"))
        {
            mMasterVolume += 1.0f;
        ...
        if (GUI.Button(new Rect(150, 200, 100, 100), "Master Volume Down"))
        {
            mMasterVolume -= 1.0f;
            mAudioMixer.SetFloat("MasterVolume", mMasterVolume);
            Debug.Log($"master volume: {mMasterVolume.ToString()}");
        ...
        //if (GUI.Button(new Rect(150, 200, 150, 100), "BGM Volume"))
        //{
           

        //}
        //if (GUI.Button(new Rect(300, 200, 150, 100), "Efx Volume"))
        //{
    ...
    void Start()
    {
        ...
        Debug.Log($"Msaster Volume: {mMasterVolume.ToString()}");
